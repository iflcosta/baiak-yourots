local config = {
	...
	{chanceFrom = 1047, chanceTo = 1997, itemId = 6279}, -- party cake
	{chanceFrom = 1998, chanceTo = 2962, itemId = 6576}, -- fireworks rocket
	{chanceFrom = 2963, chanceTo = 3872, itemId = 2995}, -- piggy bank
	...
	{chanceFrom = 6726, chanceTo = 7649, itemId = 6393}, -- cream cake
	{chanceFrom = 7650, chanceTo = 8478, itemId = 6577}, -- green balloons
	{chanceFrom = 8479, chanceTo = 9212, itemId = 3598, count = 10}, -- cookie
