local config = {
	...
	{chanceFrom = 3395, chanceTo = 5159, itemId = 900}, -- yellow pillow
	{chanceFrom = 5160, chanceTo = 6954, itemId = 651}, -- spellwand
	{chanceFrom = 6955, chanceTo = 8327, itemId = 2995}, -- piggy bank
	{chanceFrom = 8328, chanceTo = 9141, itemId = 6574}, -- bar of chocolate
	{chanceFrom = 9142, chanceTo = 9654, itemId = 6393}, -- cream cake
	{chanceFrom = 9655, chanceTo = 9850, itemId = 7377}, -- ice cream cone
	{chanceFrom = 9851, chanceTo = 9986, itemId = 906}, -- explosive present
	{chanceFrom = 9987, chanceTo = 10000, itemId = 123} -- toy mouse
}
