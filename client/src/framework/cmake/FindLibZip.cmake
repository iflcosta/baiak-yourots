...
if(MSVC)
  ...
  find_library(LIBZIP_LIBRARY_RELEASE NAMES zip.lib zip HINTS ${_VCPKG_LIB} NO_DEFAULT_PATH)
  find_library(LIBZIP_LIBRARY_DEBUG NAMES zip.lib zip HINTS ${_VCPKG_LIB_DEBUG} NO_DEFAULT_PATH)
  if(LIBZIP_LIBRARY_RELEASE AND LIBZIP_LIBRARY_DEBUG)
