...
function UIRadioGroup:selectWidget(selectedWidget, dontSignal, ignoreEqual)
  if not ignoreEqual and selectedWidget == self.selectedWidget then return end
...
function UIRadioGroup:getWidgetByIndex(index)
  return self.widgets[index]
end

function UIRadioGroup:getWidgetById(id)
